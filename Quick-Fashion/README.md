...
# 1. To generate manifest JSON only:
npx tsx scripts/bulk-create-garments.ts --folder "E:/QuickFashion/20241027/MODEL_NAME" --targetEmail "model@example.com" --sellerEmail "seller@example.com" --manifest-only
